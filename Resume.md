...
- Email: 1339184537@qq.com | icecee007@gmail.com
...
- 建设内部可视化在线搭建平台，负责组件化能力开发。
- 开发 feflow 脚手架插件。联动敏捷开发平台和代码仓库，使用命令行工具规范需求处理和涉及到的代码提交流程，防范不合规操作发生概率，并降低开发者在敏捷开发平台的手工操作负担。
...
- 开发 <a href='https://github.com/ncuhome/mincu'>mincu</a> 微应用 SDK，实现原生和 Web 通信功能，扩展内嵌页面调用原生 API 的能力。
...
- 实现 建立房间｜组队功能｜多人在线拼图｜排行榜功能

### 香樟祺微信小程序

校园疫情管控平台

- 使用 Taro + 云函数开发核心业务模块的前后端逻辑，至今稳定运行，保障校方在疫情期间准确了解学生健康状态。
